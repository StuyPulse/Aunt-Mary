...
public class SwerveDriveDriveAlignedToBarge118ScoreOppositeAllianceSide extends Command {
    ...
    public SwerveDriveDriveAlignedToBarge118ScoreOppositeAllianceSide(Gamepad driver) {
