...
public class SwerveDriveDriveAlignedToBargeScore118OppositeAllianceSide extends Command {
    ...
    public SwerveDriveDriveAlignedToBargeScore118OppositeAllianceSide(Gamepad driver) {
