...
public class SwerveDriveDriveAlignedToBargeReadyOppositeAllianceSide extends Command {
    ...
    public SwerveDriveDriveAlignedToBargeReadyOppositeAllianceSide(Gamepad driver) {
