...
public class SwerveDriveDriveAlignedToBargeScore118AllianceSide extends Command {
    ...
    public SwerveDriveDriveAlignedToBargeScore118AllianceSide(Gamepad driver) {
