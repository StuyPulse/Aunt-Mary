...
public class SwerveDriveDriveAlignedToBarge118ScoreAllianceSide extends Command {
    ...
    public SwerveDriveDriveAlignedToBarge118ScoreAllianceSide(Gamepad driver) {
