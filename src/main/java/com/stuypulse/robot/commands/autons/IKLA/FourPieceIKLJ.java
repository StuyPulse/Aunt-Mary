        ...
        addCommands(
            ...
            new ParallelCommandGroup(
                new SwerveDrivePIDToBranchScore(CoralBranch.I, 4, true)
                    ...
                    .withTimeout(1.75)
                    .deadlineFor(new LEDApplyPattern(CoralBranch.I.isLeftPegFieldRelative() ? Settings.LED.DEFAULT_ALIGN_COLOR : Settings.LED.ALIGN_RIGHT_COLOR)),
           ...
           new ParallelCommandGroup(
            ...
            new ParallelCommandGroup(
                ...
                new WaitUntilCommand(() -> Shooter.getInstance().hasCoral() || Funnel.getInstance().hasCoral())
                    .andThen(
                        new ParallelCommandGroup(
                            new SwerveDrivePIDToBranchScore(CoralBranch.J, 4, true)
                                .withTranslationalConstraints(4, 5.5)
                                .withTimeout(5)
                                .deadlineFor(new LEDApplyPattern(CoralBranch.J.isLeftPegFieldRelative() ? Settings.LED.DEFAULT_ALIGN_COLOR : Settings.LED.ALIGN_RIGHT_COLOR)),
                                new WaitUntilCommand(() -> Shooter.getInstance().hasCoral())
                                    .andThen(
                                        new ElevatorToL4Front().alongWith(new ArmToL4Front())
                                            .andThen(new ElevatorWaitUntilAtTargetHeight().alongWith(new ArmWaitUntilAtTarget()))
