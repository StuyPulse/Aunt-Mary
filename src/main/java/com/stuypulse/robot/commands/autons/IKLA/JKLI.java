...
public class JKLI extends SequentialCommandGroup {
    
    public JKLI(PathPlannerPath... paths) {
           ...
           new ParallelCommandGroup(
            ...
            new ParallelCommandGroup(
                ...
                new WaitUntilCommand(() -> Shooter.getInstance().hasCoral())
                    .andThen(
                        new ParallelCommandGroup(
                            new SwerveDriveCoralScoreAlignWithClearance(() -> CoralBranch.I, 4, true, SuperStructureState.L4_FRONT),
                                new WaitUntilCommand(() -> Shooter.getInstance().hasCoral())
                                    .andThen(
                                        new SuperStructureCoralL4Front())
                                            .andThen(new SuperStructureWaitUntilAtTarget())
