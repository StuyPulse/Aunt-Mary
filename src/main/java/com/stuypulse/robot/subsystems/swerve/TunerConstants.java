...
public class TunerConstants {
    ...
    private static final Slot0Configs steerGains = new Slot0Configs()
        .withKP(0.14362).withKI(0).withKD(0.0)
        .withKS(0.14752).withKV(0.12369).withKA(0.011085)
        .withStaticFeedforwardSign(StaticFeedforwardSignValue.UseClosedLoopSign);
    // When using closed-loop control, the drive motor uses the control
    // output type specified by SwerveModuleConstants.DriveMotorClosedLoopOutput
    private static final Slot0Configs driveGains = new Slot0Configs()
        .withKP(0.14362).withKI(0).withKD(0)
        .withKS(0.14752).withKV(0.011085);
    ...
    public static final CANBus kCANBus = new CANBus(Settings.CANIVORE_NAME, "./logs/example.hoot");
    ...
    private static final Angle kFrontLeftEncoderOffset = Rotations.of(Units.degreesToRotations(85.781250 + 180));
    ...
    private static final Angle kBackLeftEncoderOffset = Rotations.of(0.167236328125);
