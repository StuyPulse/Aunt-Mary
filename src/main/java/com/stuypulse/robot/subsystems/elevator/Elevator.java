...
public abstract class Elevator extends SubsystemBase {
    ...
    public enum ElevatorState {
        ...
        CORAL_L2_FRONT(Settings.Elevator.FRONT_L2_HEIGHT_METERS),
        CORAL_L3_FRONT(Settings.Elevator.FRONT_L3_HEIGHT_METERS),
        CORAL_L4_FRONT(Settings.Elevator.FRONT_L4_HEIGHT_METERS),
        CORAL_L2_BACK(Settings.Elevator.BACK_L2_HEIGHT_METERS),
        CORAL_L3_BACK(Settings.Elevator.BACK_L3_HEIGHT_METERS),
        CORAL_L4_BACK(Settings.Elevator.BACK_L4_HEIGHT_METERS),
