...
public interface Motors {
    ...
    public interface Arm {
        TalonFXConfig MOTOR_CONFIG = new TalonFXConfig()
            ...
            .withPIDConstants(Gains.Arm.AlgaeCatapult.PID.kP, Gains.Arm.AlgaeCatapult.PID.kI, Gains.Arm.AlgaeCatapult.PID.kD, 1)
            .withFFConstants(Gains.Arm.AlgaeCatapult.FF.kS, Gains.Arm.AlgaeCatapult.FF.kV, Gains.Arm.AlgaeCatapult.FF.kA, Gains.Arm.AlgaeCatapult.FF.kG,1)
            ...
            .withMotionProfile(Settings.Arm.Constraints.MAX_VEL_TELEOP_DEG/360, Settings.Arm.Constraints.MAX_ACCEL_TELEOP_DEG/360);
    }
    ...
    public interface Froggy {
        ...
        TalonFXConfig PIVOT_MOTOR_CONFIG = new TalonFXConfig()
            ...
            .withGravityType(GravityTypeValue.Arm_Cosine)
            .withMotionProfile(Settings.Froggy.MAX_VEL_DEG/360, Settings.Froggy.MAX_ACCEL_DEG/360)
