...
public interface Cameras {
    ...
    public Camera[] LimelightCameras = new Camera[] {
        ...
        new Camera("limelight-froggy", new Pose3d(Units.inchesToMeters(-3.886), Units.inchesToMeters(-7.835), Units.inchesToMeters(11.349), new Rotation3d(Units.degreesToRadians(0), Units.degreesToRadians(0), Units.degreesToRadians(275))), Settings.EnabledSubsystems.FROGGY_LIMELIGHT)
    };
