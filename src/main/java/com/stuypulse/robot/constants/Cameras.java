...
public interface Cameras {
    ...
    public Camera[] LimelightCameras = new Camera[] {
        ...
        // new Camera("limelight-froggy", new Pose3d(Units.inchesToMeters(-3.886255), Units.inchesToMeters(-7.835), Units.inchesToMeters(11.349)), new Rotation3d(), Settings.EnabledSubsystems)
    };
