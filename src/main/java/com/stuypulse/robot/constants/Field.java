...
public interface Field {
    ...
    public int[] BLUE_CS_TAGS = {12, 13};
    public int[] RED_CS_TAGS = {1, 2};
    public int[] BLUE_PROCESSOR = {5};
    public int[] RED_PROCESSOR = {3};
    public int[] BLUE_SIDE_BARGE_TAGS = {14, 15};
    public int[] RED_SIDE_BARGE_TAGS = {4, 5};
